...
export default function PendingApprovalPage() {
  ...
  const emailVerified = userStatus?.emailVerified ?? false;
          ...
          >
            {isPending ? (
              emailVerified ? (
                ...
                <EnvelopeIcon className="h-10 w-10 text-yellow-500" />
              )
            ) : (
        ...
        <div className="rounded-lg border border-gray-700 bg-brand-navy-light p-8">
          {isPending && !emailVerified && (
            <>
              ...
              <p className="text-center text-gray-300 mb-6">
                Your CargoWatch account is waiting for admin approval. In the meantime, please confirm your email.
              </p>

              {/* Email Verification Banner */}
              <div className="rounded-lg border border-yellow-500/20 bg-yellow-500/10 p-6 mb-6">
                <div className="flex items-start space-x-3">
                  <EnvelopeIcon className="h-6 w-6 text-yellow-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="text-sm font-semibold text-yellow-400 uppercase tracking-wide mb-2">
                      Confirm Your Email
                    </h3>
                    <p className="text-sm text-gray-300">
                      We've sent a verification email to <strong>{userStatus?.email}</strong>. 
              ...
              <div className="rounded-lg border border-gray-700 bg-brand-navy p-6 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full border-2 border-gray-600 flex items-center justify-center">
                      <div className="text-gray-600 text-xs">4</div>
                    </div>
                    <div>
                      <div className="text-gray-400 font-medium">
                        Access Granted
              ...
              <div className="rounded-lg border border-brand-red/20 bg-brand-red/10 p-4 mb-6">
                <p className="text-sm text-gray-300 text-center">
                  ...
                  24-48 hours after email confirmation
                </p>
          ...
          {isPending && emailVerified && (
            <>
              ...
              <p className="text-center text-gray-300 mb-6">
                Thank you for confirming your email! Your CargoWatch account is now under review by our team.
              </p>

              {/* Success Banner */}
              <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-6 mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Your email address <strong>{userStatus?.email}</strong> has been successfully verified.
                    </p>
                  </div>
                </div>
              </div>
